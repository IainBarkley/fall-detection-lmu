...
OUT_DIR = Path("fall_detection_data/models/cnn_only_bs512_lr1e3")
OUT_DIR.mkdir(parents=True, exist_ok=True)

X_data = np.load(DATA_DIR / "X_data_6class.npy")
y_labels = np.load(DATA_DIR / "y_labels_6class.npy")
y_categorical = keras.utils.to_categorical(y_labels, num_classes=6)
label_map = json.load(open(DATA_DIR / "label_map_6class.json"))
